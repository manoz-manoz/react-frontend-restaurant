...
function Hersection() {
  return (
    ...
    <Link to="/menu"> <button className='px-[2.5rem] py-[0.8rem] bg-white text-lg font-semibold mt-[2em] duration-[0.5s] rounded-full hover:text-white hover:bg-black  '> View Menu</button></Link>
